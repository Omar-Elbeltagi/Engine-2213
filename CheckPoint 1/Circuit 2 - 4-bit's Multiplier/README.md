...
<img width="630" height="1155" alt="Multiplication truth table" src="https://github.com/user-attachments/assets/fa43689d-502d-4016-918b-6b5d85e6b668" /> (Multiplication truth table)
...
<img width="590" height="377" alt="S1 LSB (A1 B1)" src="https://github.com/user-attachments/assets/eb0a4388-2da6-43ec-91d6-bd804e92496b" /> ( S1 LSB (A1 B1) )
...
<img width="387" height="382" alt="Example of Binary multiplication process" src="https://github.com/user-attachments/assets/b0e8ccb0-00f7-4b35-85a5-b05e8d33236d" /> (Example of Binary multiplication process)

These shifted partial products are then added together using full adders, which combine the values and propagate carries between bits. This's ensures that all partial results are properly summed to produce the final binary product.
